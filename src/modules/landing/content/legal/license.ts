...
export const licenseContent: LegalPage = {
  ...
  intro: [
    "When you purchase {appName}, you are granted access to the complete source code, documentation, and associated materials under the Solo Developer License described below.",
  ...
  sections: [
    {
      ...
      list: {
        type: "numbered",
        items: [
          "{appName} retains ownership of all materials (source code and documentation) but grants you usage rights under the terms of this license.",
          ...
          "This is a license, not a sale. You do not acquire ownership rights in {appName} itself.",
        ],
      },
    },
    {
      ...
      list: {
        ...
        items: [
          ...
          "Receive all future updates at no additional cost for as long as {appName} is distributed.",
        ],
      },
    },
    {
      ...
      list: {
        type: "bulleted",
        items: [
          "Resell, sublicense, or redistribute the {appName} source code, documentation, or any substantial portion of it — as a boilerplate, starter kit, template, course asset, or competing product.",
          "Publish the {appName} source code to any public repository, including public GitHub, GitLab, Bitbucket, or any publicly accessible Git host.",
          "Repackage, rebrand, or re-skin {appName} and distribute it as your own work.",
          "Share your license credentials, download link, or purchase receipt with other developers to enable their use of {appName}.",
    ...
    },
    {
      ...
      paragraphs: [
        "This License covers ONE individual human developer. If multiple developers on your team need hands-on access to the {appName} source code, each developer must purchase their own License.",
    ...
    },
    {
      ...
      paragraphs: [
        "You are permitted to use {appName} to build applications you deliver to clients as a freelancer or contractor. The following rules apply:",
      ],
      list: {
        type: "bulleted",
        items: [
          ...
          "If your client later wants in-house developers to maintain or extend the codebase, those developers each need their own License to access the {appName} source and patterns.",
          "You may not hand the client a copy of the raw {appName} source tree and claim they are licensed to use it. They are not.",
        ],
      },
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "{appName} is sold as a documentation-first product. The primary reference is the included Docusaurus documentation, covering setup, architecture, every feature, troubleshooting scenarios, and deployment. The kit is self-contained by design — a reference that scales with your project.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Upon refund, your License is terminated and you must cease all use of {appName} and delete all copies in your possession.",
      ],
    },
    {
      heading: "No warranty and limitation of liability",
      paragraphs: [
        "{appName} is provided as-is and as-available, without warranty of any kind, express or implied, including but not limited to warranties of merchantability, fitness for a particular purpose, or non-infringement.",
        "In no event shall {appName}, its contributors, or affiliates be liable for any claim, damages, loss of profits, loss of data, business interruption, or other liability arising from, out of, or in connection with {appName} or its use.",
        "You are solely responsible for the applications you build with {appName}, including their security, compliance with applicable laws (such as GDPR, CCPA, UU PDP, or other local equivalents), and fitness for your end users. {appName} provides a starting point, not a compliance guarantee.",
        "Total aggregate liability under this License shall not exceed the amount you paid for {appName} in the twelve months preceding the claim.",
      ],
    },
    {
      heading: "Termination",
      paragraphs: [
        ...
        "Upon termination, you must cease all use of {appName} and destroy all copies, complete or partial, in your possession or control.",
    ...
    },
    {
      ...
      paragraphs: [
        `This License shall be governed by and construed in accordance with the laws of ${brandingConfig.legalJurisdiction}, without regard to its conflict of laws provisions.`,
        `Any dispute shall first be attempted to be resolved through good-faith negotiation. If unresolved within thirty days, the dispute shall be brought before the competent courts of ${brandingConfig.legalJurisdiction}.`,
      ],
    },
    {
      heading: "Terms modification",
      paragraphs: [
        "{appName} may modify these license terms from time to time. Any changes will not be retroactive and will not affect licenses purchased before the modification date.",
